...
urlpatterns += [
    ...
    path(
        ...
        name="shop-customer-list-create",
    ),
    path("shop/bills/", views.BillListCreateView.as_view(), name="bill-list-create"),
    path(
        "shop/bills/<int:pk>/pay-cash/",
        views.BillPayCashView.as_view(),
        name="shop-bill-pay-cash",
    ),
